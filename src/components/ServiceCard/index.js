...
class ServiceCard extends React.Component {
  ...
  render() {
    return (
      <div className="fl w-100 w-50-m w-25-l pv3 pa3-m pa3-l">
        <Link
          to={"services/" + this.props.name}
          title={this.props.title}
          className="tc bg-black br2 db no-underline aspect-ratio aspect-ratio--5x7 grow"
        ...
        >
          <div className="aspect-ratio--object ph4 pv5">
            ...
            <p className="sans-serif f6 black-60 ml-auto mr-auto mb0 measure-narrow lh-title">{this.props.description}</p>

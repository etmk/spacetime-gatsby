...
const StartupServicesPage = ({ transition }) => (
  <div className="service-page content-page">
    ...
    <section id="concept-exploration" className="ph3 ph5-m ph7-l pt4 pb5 gradient-light-blue">
      <h3 className="f1 fw7 bb bw2 dib dark-red tracked-tight relative mb3"><span className="no-underline absolute left--4 left--2-m left--4-l black-20 f4 top-1 tracked">1</span>Concept Exploration</h3>
    ...
    <section id="minimum-viable-product" className="ph3 ph5-m ph7-l pt4 pb5 gradient-light-blue">
    ...
    <section id="startup-resuscitation" className="ph3 ph5-m ph7-l pt4 pb5 gradient-light-blue">
    ...
    <section id="choose-your-own-adventure" className="ph3 ph5-m ph7-l pt4 pb5 gradient-light-blue">

  ...
  <Layout>
    ...
    <PageHero
      ...
      bgImage="/portfolio/keyzie/keyzie-bg.jpg">
        ...
        <h1 className="t-headline">Keyzie&mdash;<span className="o-40">the future of real estate is personal</span></h1>
    </PageHero>
    ...
    <MainWrapper>
      ...
      <OutboundLink
        ...
        target="_blank"
        className="big-circle-button hover-bg-orange center mb7">
        Visit Keyzie ↗
      </OutboundLink>

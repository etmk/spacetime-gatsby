...
const FluidityTechPage = () => (
  <Layout>
    <Helmet
      title={`🛸Fluidity Tech • Revolutionizing drone control`}
      meta={[
    ...
    <PageHero
      ...
      bgImage="/portfolio/fluidity-tech/fluidity-bg.jpg">
        ...
        <h1 className="t-headline">Fluidity Tech&mdash;<span className="o-40">revolutionizing drone control</span></h1>
    </PageHero>

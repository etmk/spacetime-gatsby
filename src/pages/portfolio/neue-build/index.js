...
const WatermarkPage = () => (
  <Layout>
    <Helmet
      title={`🔨NeueBuild • New build, new home, move in ready`}
      meta={[
        ...
        { name: 'keywords', content: 'neuebuild' },
      ]}
      link={[
    ...
    <PageHero
      ...
      bgImage="/portfolio/neue-build/neue-build-bg.jpg">
        ...
        <h1 className="t-headline">NeueBuild&mdash;<span className="o-40">new build, new home, move in ready</span></h1>
    </PageHero>
    ...
    <MainWrapper>
      ...
      <OutboundLink
        href="https://neuebuild.com/"
        target="_blank"
        className="big-circle-button hover-bg-washed-blue center mb7">
        Visit NeueBuild ↗
      </OutboundLink>

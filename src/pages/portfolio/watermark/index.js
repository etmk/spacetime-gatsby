...
const WatermarkPage = () => (
  <Layout>
    <Helmet
      title={`💧Watermark Community Church • Church Website & Design`}
      meta={[
        { name: 'description', content: 'Watermark Community Church website' },
    ...
    <PageHero
      bgColor="#000"
      bgImage="/portfolio/watermark/watermark-bg.jpg">
        <img src="/client-logos/watermark-community-church-icon.svg" className="" alt="Watermark Community Church logo" />
        <h1 className="t-headline">Watermark&mdash;<span className="o-40">one church, four campuses, thousands of locations</span></h1>
    </PageHero>

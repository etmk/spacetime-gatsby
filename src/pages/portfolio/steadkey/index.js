  ...
  <Layout>
    <Helmet
      ...
      meta={[
        ...
        { name: 'keywords', content: 'steadkey' },
      ]}
      link={[
    ...
    <PageHero
      ...
      bgImage="/portfolio/steadkey/steadkey-bg.jpg">
        ...
        <h1 className="t-headline">Steadkey&mdash;<span className="o-50">delivery sanity and clarity to the mortgage process</span></h1>
    </PageHero>
    ...
    <MainWrapper>
      ...
      <div className="pv5 pv6-ns row narrow">
        ...
        <small className="i o-50">Note: the Steadkey site and app design have changed since working with Spacetime</small>
      </div>
